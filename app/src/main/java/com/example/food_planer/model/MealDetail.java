...
public class MealDetail {
    ...
    public Object dateModified;
        ...
        public static ArrayList<IngredientMesure> ingredientsMeasure(MealDetail meal) {
            ArrayList<IngredientMesure> ingredientMeasures = new ArrayList<>();
            for (int i = 1; i <= 20; i++) {
                ...
                if (ingredient != null && !ingredient.isEmpty() && measure != null && !measure.isEmpty()) {
                    ingredientMeasures.add(new IngredientMesure(ingredient, measure));
                }
            }
            return ingredientMeasures;
        }

        private static String getIngredient(MealDetail meal, int index) {
            try {
        ...
        private static String getMeasure(MealDetail meal, int index) {
            try {
